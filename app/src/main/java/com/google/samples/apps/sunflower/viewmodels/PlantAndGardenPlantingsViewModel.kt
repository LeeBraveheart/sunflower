...
import com.google.samples.apps.sunflower.data.MyDate
...
//    val waterDateString: String = dateFormat.format(gardenPlanting.lastWateringDate.time)
    val waterDateString: String = gardenPlanting.lastWateringDate.time()
...
//    val plantDateString: String = dateFormat.format(gardenPlanting.plantDate.time)
    val plantDateString: String = gardenPlanting.plantDate.time()
    val plantId
        get() = plant.plantId
